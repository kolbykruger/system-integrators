    ...
    function Xa(u, t) {
        ...
        return (
            !e &&
                s(u) &&
                ((h = e = u.radius || U),
                u.values ? ((u = Tt(u.values)), (l = !q(u[0])) && (h *= h)) : (u = Wa(u.increment))),
            Ma(
                t,
                e
                    ? p(u)
    ...
    var Lt,
        ...
        Ft =
            ...
            (Lt.isActive = function isActive() {
                ...
                return !(
                    e &&
                    !(this._ts && this._initted && e.isActive() && (t = e.rawTime(!0)) >= r && t < this.endTime(!0) - j)
                )
            }),
    ...
    var Bt = (function (n) {
        ...
        return (
            ...
            (e.staggerFromTo = function staggerFromTo(e, r, i, n, a, s, o, u) {
                return (
                    (n.startAt = i), (oa(n).immediateRender = t(n.immediateRender)), this.staggerTo(e, r, n, a, s, o, u)
                )
            }),
                ...
                return arguments.length
                    ? ((this._forcing = 1),
                      !this._dp &&
                          this._ts &&
                          (this._start = ca(
                              Pt.time - (0 < this._ts ? t / this._ts : (this.totalDuration() - t) / -this._ts)
                          )),
                        ...
                        ja(
                            {
                                ...
                                duration:
                                    e.duration ||
                                    Math.abs((i - (n && 'time' in n ? n.time : r._time)) / r.timeScale()) ||
                                    j,
                            ...
                            if (
                                ...
                                t._startAt && e < 0 && t._startAt.render(e, !0, !0),
                                    ...
                                    (e >= t._tDur || e < 0) &&
                                        t.ratio === u &&
                                        (u && sa(t, 1),
                                        r || (xt(t, u ? 'onComplete' : 'onReverseComplete', !0), t._prom && t._prom()))
                ...
                (e.kill = function kill(t, e) {
                    ...
                    for (
                        ...
                        if (~d.indexOf(f[l]))
                            ...
                            s))
                                (h = n && n[u]) &&
                                    (('kill' in h.d && !0 !== h.d.kill(u)) || ra(this, h, '_pt'), delete n[u]),
                                    'all' !== a && (a[u] = 1)
    ...
    var ne = {
        ...
        exportRoot: function exportRoot(e, r) {
            ...
            for (
                ...
                (n = i._next),
                    (!r && !i._dur && i instanceof Vt && i.vars.onComplete === i._targets[0]) ||
                    ...
                    if ('autoRound' !== f && ((s = e[f]), !ft[f] || !Qb(f, e, r, i, t, n)))
                        if (
                            ...
                            if (
                                ...
                                if (
                                    (m ||
                                        ...
                                        ((m = this._pt =
                                            new ie(this._pt, T, qe, 0, 1, g.renderTransform, g, 0, -1)).dep = 1)),
                                    'scale' === f)
                                )
                            ...
                            if (_ || ((o || 0 === o) && (u || 0 === u) && !Fe.test(s) && f in T))
                                (o = o || 0),
                                    (d = (a + '').substr((u + '').length)) !==
                                        (c = Oa(s) || (f in Y.units ? Y.units[f] : d)) && (u = xd(t, f, a, c)),
                                    (this._pt = new ie(
                                        this._pt,
                                        _ ? g : T,
                                        f,
